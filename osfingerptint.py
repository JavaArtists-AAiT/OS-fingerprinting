...
# elif response == '5':
#     print(scanner.scan("127.0.0.1", arguments="-O -Pn")['scan']['127.0.0.1']['osmatch'][-1])
...
try:
    ...
    print('Service currently unavailable.', sys.exc_info()[0])
    sys.exit(0)

print(nm.scan(hosts=target_ip, arguments='-sV -O -v'))